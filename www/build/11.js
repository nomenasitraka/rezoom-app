...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lieu_detail__ = __webpack_require__(365);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_transfer__ = __webpack_require__(230);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_file_path__ = __webpack_require__(231);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_email_composer__ = __webpack_require__(232);
...
var LieuDetailPage = /** @class */ (function () {
    function LieuDetailPage(navCtrl, navParams, rezoom, camera, transfer, file, filePath, actionSheetCtrl, toastCtrl, platform, loadingCtrl, nativeStorage, emailComposer, network, storage) {
        var _this = this;
    ...
    LieuDetailPage.prototype.ionViewDidLoad = function () {
        ...
        if (!navigator.onLine) {
            this.nativeStorage.getItem('lieux').then(function (lieux) {
                ...
                console.log(lieux);
                var lieu = lieux.lieux.filter(function (elt) { return elt.lieu.id_lieux_rezoom == _this.id_lieu; })[0];
                console.log(lieu);
    ...
    LieuDetailPage.prototype.getWeekNumber = function (d) {
